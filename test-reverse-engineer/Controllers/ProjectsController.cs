...
namespace test_reverse_engineer.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ProjectsController(pmo_db5Context context)
        {
            _context = context;
        }
        ...
        {
            var pmo_db5Context = _context.Project.Include(p => p.ClosingNavigation).Include(p => p.ExecuteNavigation).Include(p => p.InitiativeNavigation).Include(p => p.PlanNavigation);
