        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DOC_SIZE = table.Column<decimal>(type: "decimal(18, 0)", nullable: true),
                    DOC_FORMAT = table.Column<string>(unicode: false, maxLength: 10, nullable: true),
                    DOC_STREAM = table.Column<byte[]>(nullable: true),
                    DOC_CATEGORY = table.Column<string>(unicode: false, maxLength: 30, nullable: true),
